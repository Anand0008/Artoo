...
> **Built and maintained by [Telomere LLC](https://telomeregs.com), a Maryland-based software engineering firm.**
...
```bash
git clone https://github.com/Loki1920/artoo.git
cd artoo
```
...
```env
METRICS_PORT=8080
METRICS_API_KEY=<redacted>             # protects approve/reject endpoints
...
Artoo is distributed under the [Telomere Proprietary Freeware License](LICENSE). You are granted a free, non-transferable license to use Artoo for internal business operations. Copying, redistribution, modification, rebranding, or representing Artoo as your own intellectual property is strictly prohibited.
