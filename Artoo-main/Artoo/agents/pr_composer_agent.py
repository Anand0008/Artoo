...
from mcp_client.client_factory import filter_github_tools, filter_jira_tools, get_mcp_client
...
async def _do_create_pr(state: dict) -> PRCompositionResult:
    ...
    # Post Jira comment with PR link (status transition is left to human reviewers)
    if pr_url:
