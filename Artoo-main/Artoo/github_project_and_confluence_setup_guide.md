...
> Step-by-step instructions to create a test project that the Artoo can
...
With all three services set up, fill in your `.env` file in the `artoo` project root:
